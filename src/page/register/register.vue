<template>
  <div class="register-layer">
    ...
    <div class="btn-banner">
      <el-button type="primary" class="apply" @click.stop="apply">申请入驻</el-button>
    </div>
  </div>
</template>

<script>
  import FileUploadRatio from '../../components/dialog/FileUploadRatio.vue'
  ...
  export default{
    ...
    methods: {
      ...
      apply:function () {
        ...
        this.$api.api.supplierInfoAdd.post({
          name:this.name,
          ...
          function(res){
            if(!res.data.errorCode){
              that.$tool.toast("注册成功,等待审核", 2000);
