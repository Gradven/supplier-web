<template>
  <div class="orderSend-layer">
    ...
    <div class="box" v-if="orderGoodsItem.payStatus == 1 && orderGoodsItem.shippingStatus == 0">
      ...
      <div class="row">
        <div class="label">运费(元):</div>
        <el-input v-model="shippingFee" placeholder="运费" auto-complete="off"></el-input>
      </div>
      <div class="clear"></div>
    </div>
  </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      getOrderGoodsById:function(){
        ...
        this.$api.api.getOrderGoodsById.get({
          ...
          function(res){
            ...
            that.getOrderInfoBySn(orderSn);
            that.getOrderInvoiceBySn(orderSn);
          }
        ).catch(
          function(err){
      ...
      getOrderInfoBySn:function(orderSn){
        let that = this;
      ...
      getOrderInvoiceBySn:function(orderSn){
        let that = this;
